...
const usuarios_normales = require('./api/routes/usuarios_normales.route');
app.use('/api', usuarios_normales)
/*const usuarios_tarjeta = require('./api/routes/usuarios_normales.route');
app.use('/api', usuarios_tarjeta)*/
