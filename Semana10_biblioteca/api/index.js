...
mongoose.connect('mongodb+srv://admin:1admin9@pollux-rt1ni.mongodb.net/proyecto?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, function(err, database) {
    if (err) {
        console.log(err);
        process.exit(1);
    }
...
const publisher = require('./components/publishers/publishers.route');
